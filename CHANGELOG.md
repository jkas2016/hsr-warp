...
### 추가됨
- 스타레일 **4.5 픽업 배너**를 반영한다 — 1페이즈(로빈•서머레토·히아킨)와 2페이즈(아벤츄린•웨이브플레어·애쉬베일), 각 전용 광추까지 포함한다. 반영 전에는 배너 일정이 8월 25일에서 끊겨 있어, 4.5 에서 뽑은 픽업 캐릭터가 전부 **픽뚫**로 세어지고 뒤따르는 5★ 까지 '확정'으로 잘못 소비돼 승률이 조용히 낮게 나왔다. 신규 캐릭터·광추 이름도 4개 언어로 함께 갱신했다 (#69)
...
[1.1.3]: https://github.com/jkas2016/hsr-warp/releases/tag/v1.1.3
