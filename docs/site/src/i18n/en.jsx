...
export default {
  ...
  faqSec: {
    ...
    items: [
      ...
      { q: 'How far back can it fetch?', a: <>As far back as the game server returns. <b>Zenless Zone Zero</b> only returns roughly the <b>last 6 months</b>, so Signal Search records older than that are already out of reach the first time you fetch. <b>Honkai: Star Rail</b>, in our testing, returned Warp records older than 6 months as well (this is a server-side policy HoYoverse can change at any time). Once fetched, records are kept here forever — the earlier you start, the longer your history.</> },
